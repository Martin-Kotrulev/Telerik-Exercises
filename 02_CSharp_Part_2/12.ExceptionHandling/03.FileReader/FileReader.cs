...
/* 03. Write a program that enters file name along with its 
 * full file path (e.g. C:\WINDOWS\win.ini), reads its contents 
 * and prints it on the console. Find in MSDN how to use 
 * System.IO.File.ReadAllText(…). Be sure to catch all possible exceptions 
    ...
    static void Main()
    {
        ...
        catch (ArgumentException)
        {
            Console.Error.WriteLine(
                "Path is a zero-length string, contains only white" + 
